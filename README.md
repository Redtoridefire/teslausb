...
To enable teslausb to act as a wifi access point with the given SSID and Passord, find this section in your teslausb_setup_variables.conf file and uncomment the exports. Remember to change the password to something that protects your Pi.  You will not get access to The Internet but you will be able to ssh into your Pi to see whats going on. Be careful when using this option. Your AP_PASS setting is all that protects your Pi and the access of the teslausb_setup_variables.conf saved on your Pi. 
   ```
