...
then
  /root/bin/send-push-message "TeslaUSB: Music Copy complete" "Copied $NUM_FILES_COPIED music file(s), skipped $NUM_FILES_SKIPPED previously-copied files, encountered $NUM_FILES_ERROR errors."
fi
